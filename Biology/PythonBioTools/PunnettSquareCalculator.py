...
seperateTraits[0] = orderListsElements(int(len(parent1)/2), seperateTraits[0])

for y in seperateTraits[0]:
...
for x in range(0, len(seperateGenomes)):
    print(str(x + 1) + "   " + str(seperateGenomes[x]) + "      " + str((seperateGenomesCount[x]/len(seperateTraits[0])) * 100) + "%" )
